var firebaseConfig = {
    ...
    "databaseURL": process.env.REACT_APP_projectId?"https://"+process.env.REACT_APP_projectId+(process.env.REACT_APP_databasePrefix?process.env.REACT_APP_databasePrefix:"-default-rtdb")+".firebaseio.com":"https://tester-8e38d.firebaseio.com",
